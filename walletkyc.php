...
?>
    ...
    <head>
        ...
        <title>Wallet Upgrade Kyc</title>
        ...
        <meta name="description" content="Upgrade Wallet - PayflipWallet ,online recharge fast service in india, prepaid recharges, postpaid recharges, dth recharges, googleplay recharge and more..">
...
<div class="headerlogo">PayflipWallet</div>
        ...
        <div class="card77" style="top:10px;margin-bottom:-35px">
            <h1 style="font-weight:500;color:#ff6347;margin-bottom:41px;margin-top:0px;">Wallet Upgrade</h1>
            <h1 style="font-size:17px;margin-bottom:20px;margin-top:20px;text-align:center;">COMING SOON !</h1>
        </div>
        </div>
        </div>
