<?php 
require('auth/resetpassword.php');
?>
    <!DOCTYPE html>
    <html lang='en-US'>
    ...
    <head>
        ...
        <meta name="description" content="ResetPassword - PayflipWallet ,online recharge fast service in india, prepaid recharges, postpaid recharges, dth recharges, googleplay recharge and more..">
    ...
    <body class="scrollbar1" id="scrollbar-custom">
        <div class="header">
<div class="headerlogo">PayflipWallet</div>
            <div class="header-right">
                ...
                <div class="user_icon">
                    <div class="header-right-user">
                        <div class="dropdown">Log In/ Sign Up
                            <div class="dropdown-content">
                                <a href="https://payflipwallet.com/login">LOGIN</a>
                                <a href="https://payflipwallet.com/signup">SIGNUP</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="recharge_card" style="margin-bottom:75px">
            <div class="card-header">Reset Password</div>
            <br>
            <?php if(isset($msg)){echo $msg;}?>
                <form method="POST" action="" id="resetpassword-form" autocomplete="off">
                    <img style="margin:0 0 -40px" src="/resource/images/ic_lock.png" height="20" width="20">
                    <input type="password" name="newpassword" id="newpassword" maxLength="15" placeholder="New Password">
                    <img style="margin:0 0 -40px" src="/resource/images/ic_lock.png" height="20" width="20">
                    <input type="password" name="cpassword" id="cpassword" maxLength="15" value="" placeholder="Confirm Password">
                    <input type="submit" name="submit" value="Create Password" class="btn red">
                </form>
                <br>
        </div>
        <br>
