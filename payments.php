...
require_once('auth/session/session.php'); 
 ?>
    ...
    <head>
        ...
        <title>Payments | PayflipWallet</title>
        ...
        <meta name="description" content="Wallet Pay - PayflipWallet ,online recharge fast service in india, prepaid recharges, postpaid recharges, dth recharges, googleplay recharge and more..">
...
<div class="headerlogo">PayflipWallet</div>
        ...
        <div class="card3">
            <div style="float:left;margin-left:45.5%;margin-top:72px;width:auto;height:130px">
                <img src="/resource/images/wallet.png" style="width:100px">
                <div style="text-align:center;font-size:20px;margin-top:-2px;">&#x20B9;<?php echo $wallet;?></div>
                <div style="font-size:12px">Available Balance</div>
            </div>
        </div>
        <div class="card" style="margin:-100px 32% -35px;width:34%">
		<span id="msg"></span>
		<?php include "auth/payments.php"; ?>
		<script>
		function walletcheck(){
			if(<?php echo $wallet;?>>=<?php echo $amount;?>){
				$("#paybutton").html('<span class="spinnerpay"></span>')
			}else{
				alert("Load Money Now");
			}
		}		
		</script>
