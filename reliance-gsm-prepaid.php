...
?>
    ...
    <head>
        ...
        <title>Reliance Prepaid Recharge</title>
...
<div class="headerlogo">PayflipWallet</div>
        ...
        <div class="recharge_card">
            <div class="card-header">
                <img style="margin-right:8px;" src="/resource/logos/operators/42x42/reliance-gsm.png" alt="Reliance GSM" title="Reliance GSM"></div>
            <br>
            <div id="error"></div>
