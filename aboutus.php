...
?>
    ...
    <head>
        ...
        <meta name="description" content="AboutUs - PayflipWallet ,online recharge fast service in india, prepaid recharges, postpaid recharges, dth recharges, googleplay recharge and more..">
...
<div class="headerlogo">PayflipWallet</div>
        ...
        <div class="card77" style="margin-top:-255px;margin-bottom: 8px;">
            <h4 style="font-weight:500;color:#7a7a7a;margin-bottom:20px;margin-top:20px">About Us</h4>
            <p>
                Payflip Wallet is India’s No.1 Online Payments Website & App. Customers across the country use PayflipWallet to make mobile prepaid, mobile postpaid, datacard prepaid, datacard postpaid, DTH Recharge and utility bill payments for service providers. We launched our wallet in 2016 and customers are already using it to pay across all major online platforms and offline stores like Shoppers Stop, McDonalds, Cinepolis, HomeStop, Crosswords, Hypercity and even for E-Rickshaws, the list is growing by the day.</p>
            <p>
                We are on a mission to get million make happy merchant and happy user in india, Pays Merchant Stores after 1 minute registering on the PayflipWallet App.

            </p>
            <h4 style="font-weight:500;color:#7a7a7a;margin-bottom:20px;margin-top:20px">PayflipWallet Promise:</h4>
            <li>An easy and fast recharging process</li>
            <li>An easy and fast loadmoney process</li>
            <li>A safe and secure payment process</li>
            <li>A safe and secure money send friends & banks Accounts</li>
            <li>Simple Merchant Pays with no hidden costs</li>
            <li>An easy and fast refund cash on PayflipWallet</li>
            <li>PayflipWallet team helping 24X7 hours</li>
            <br>
        </div>
        </div>
        </div>
