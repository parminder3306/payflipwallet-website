...
?>
    ...
    <head>
        ...
        <meta name="description" content="Forget Password - PayflipWallet ,online recharge fast service in india, prepaid recharges, postpaid recharges, dth recharges, googleplay recharge and more..">
        ...
        <script type="text/javascript" src="/resource/ajax/forget.js"></script>
...
<div class="headerlogo">PayflipWallet</div>
        ...
        <div class="recharge_card" style="margin-bottom:125px">
            <div class="card-header">Forget Password</div>
            <br>
            <div id="msg"></div>
            <form method="POST" action="" id="forget-form" autocomplete="off">
