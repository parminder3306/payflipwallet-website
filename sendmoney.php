...
?>
    ...
    <head>
        ...
        <meta name="description" content="SendMoney - PayflipWallet ,online recharge fast service in india, prepaid recharges, postpaid recharges, dth recharges, googleplay recharge and more..">
        ...
        <script type="text/javascript" src="/resource/ajax/sendmoney.js"></script>
    ...
    <body id="scrollbar-custom">
            ...
            <ul>
                ...
                <li class="active">
                    <a href="javascript:void(0);">
                        <div><img src="/resource/images/sendmoney.png" height="35" width="35" alt="SendMoney" title="SendMoney"></div><span class="pd5">SendMoney</span></a>
                </li>
                <li>
        ...
        <div class="sendmoney-card" style="margin-bottom:93px">
            <div class="card-header">SendMoney <span id="servicetax"></span></div>
            <br>
            <div id="msg"></div>
            <form method="POST" action="" autocomplete="off" id="sendmoney-form">
                ...
                <input name="amount" type="text" id="amount" maxLength="4" onkeyup="showUser(this.value)" placeholder="Amount">
                <input type="hidden" name="tax" id="tax" placeholder="Amount">
                <input type="submit" name="sendmoney" id="sendmoney" value="Send Money" class="btn red">
            </form>
            <br>
        </div>
