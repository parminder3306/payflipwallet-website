<?php require_once('auth/session/session.php');
 ?>
    ...
    <head>
        ...
        <title>GooglePlay Recharge</title>
        ...
        <meta name="description" content="Google Play - PayflipWallet ,online recharge fast service in india, prepaid recharges, postpaid recharges, dth recharges, googleplay recharge and more..">
...
<div class="headerlogo">PayflipWallet</div>
            ...
            <ul>
                ...
                <li class="active">
                    <a href="javascript:void(0);">
                        <div><img src="/resource/images/googleplay.png" height="35" width="35" alt="Google Play" title="Google Play"></div><span class="pd5">Google Play</span></a>
                </li>
                <li>
        ...
        <div class="recharge_card" style="margin-bottom:45px">
            <div class="card-header">GooglePlay Recharge</div>
            <br>
            <div id="error"></div>
            <form method="POST" action="" id="googleplay-form" autocomplete="off">
                <img style="margin:0 0 -40px" src="resource/images/ic_phone.png" height="20" width="20">
                <input type="text" id="mobile" name="mobile" value="" maxlength="10" placeholder="Mobile Number">
               ...
               <div class="amount-filter">
                ...
                <button type="submit" name="googleplay" id="google-play" class="btn red">Proceed</button>
            </form>
            <br>
        </div>
        </div>
