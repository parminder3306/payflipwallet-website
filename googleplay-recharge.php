<?php
	require_once('auth/googleplay-recharge.php');
	?>
    <!DOCTYPE html>
    <html lang='en-US'>
    ...
    <head>
        ...
        <meta name="description" content="GooglePlay Recharge - PayflipWallet ,online recharge fast service in india, prepaid recharges, postpaid recharges, dth recharges, googleplay recharge and more..">
    ...
    <body id="scrollbar-custom">
        ...
        <div class="card3"></div>
        <div class="card">
            <div style="margin:10px 175px 20px;" class="GOOGLEPLAY"></div>
            <form method="POST" action="">
                ...
                <?php if(isset($discount)){echo $discount;}?>
                    <p class="mt10">
