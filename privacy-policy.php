<?php 
require_once('auth/session/db.php');
?>
    <!DOCTYPE html>
    <html lang='en-US'>
    ...
    <head>
        ...
        <meta name="description" content="Terms and Conditions- PayflipWallet ,online recharge fast service in india, prepaid recharges, postpaid recharges, dth recharges, googleplay recharge and more..">
...
<div class="headerlogo">PayflipWallet</div>
            <div style="float:right;margin-top:13px;">
                <a style="padding:5px;background-color:#0073cf;color:#fff;border-radius:2px" href="https://payflipwallet.com">BACK HOME</a>
            </div>
        </div>
        <div class="card3"></div>
  	<div class="footer-menu" style="width: max-content;margin-top:-245px;margin-left:70px;">
                           <ul style="padding:0">
        ...
        <div class="card77" style="margin-top:-255px;margin-bottom: 8px;">
            <h4>Privacy Policy</h4>
            <p>In using this website you are deemed to have read and agreed to the following terms and conditions:</p>
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and any or all Agreements:"Client", "You" and "Your" refers to you, the person accessing this website and accepting the Company's terms and conditions. "The Company", "Ourselves", "We" and "Us", refers to PayflipWallet.com or Payflip Systems Pvt. Ltd "Party", "Parties" refers to both the Client and ourselves, or either the Client or ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to undertake the process of our assistance to the Client in the most appropriate manner. Any use of the above terminology or other words in the singular, plural, capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to same. By becoming a registered user of PayflipWallet.com and our affiliate sites, you agree to be contacted by PayflipWallet.com and our affiliates via communication modes including but not limited to email, SMS, MMS, and telephonic calls.</p>
            <p>You agree that PayflipWallet may, in its sole discretion and without prior notice, terminate Your access to the Website and block Your future access to the Website if PayflipWallet determines that You have violated the terms of these Terms of Use or any other Agreement(s). You also agree that any violation by You of the Agreement(s) will cause irreparable harm to PayflipWallet, for which monetary damages may be inadequate, and You consent to PayflipWallet obtaining any injunctive or equitable relief that PayflipWallet deems necessary or appropriate in such circumstances. These remedies are in addition to any other remedies PayflipWallet may have at law or in equity.</p>
            <p>PayflipWallet reserves the right to refuse access to use the Services offered at the Website to new Users or to terminate access granted to existing Users at any time without according any reasons for doing so.</p>
            <h4>Payment</h4>
            <p>We accept Visa and Master Credit Card, Debit Cards and Net banking as mode of payments which are processed through our payment gateway partner PayU (India) Pvt Ltd. No information pertaining to payment is shared with us as you fill all the payment related information on your bank's site.</p>
            <h4>Recharge</h4>
            <p>PayflipWallet has tied up with a third party enabler for the recharge. PayflipWallet is not responsible for any delay, pricing or cancellation of recharge from mobile operators end. Though, best efforts are made to keep the service above acceptance levels. </p>
            <p>User is solely responsible for the selection of mobile operator and the recharge amount. PayflipWallet is not responsible for talk-time given against recharge done through PayflipWallet.com as this is purely at mobile operator's disposal.</p>
            <h4>Consent to use Contact Information</h4>
            <p>You agree that we may collect, use and share certain information regarding the contacts contained in Your device’s phone book (“Contact Information”) for promotional and marketing purpose and also share it with any third party in accordance with the Privacy Policy. By allowing Contact Information to be collected, You give PayflipWallet a right to use that Contact Information as a part of the service provided by PayflipWallet and you guarantee that you have any and all permissions required to share such Contact Information with us.</p>
            <h4>Refunds Money</h4>
            <p>All sales are final with no refund or exchange permitted. You are responsible for the payment of the mobile number or DTH account number or bill payment and all charges that result from these payments. We shall not be responsible for any payment for an incorrect mobile number or DTH account number or bill payment number. In case, money has been charged to your card or bank account or pre-paid payment instrument and a payment/service is not delivered by the service provider within 24 hours of your completion of the transaction then you may inform us regarding the same by sending an email to <a href="mailto:care@payflipwallet.com">care@payflipwallet.com</a>. Please include in the email the following details â the mobile number or DTH account number or bill payment number, service provider name, payment value, transaction date and order number. We shall investigate such incidents and if it is found that money was indeed charged to your card or bank account or pre-paid payment instrument without delivery of the payment/service then you will be refunded the money within 21 working days from the date of receipt of your email. All refunds will be credited to your card or bank account or the PayflipWallet Balance. We shall have the sole discretion to determine the mode of reversal from the above mentioned options.</p>
            <h4>Coupon Redemption</h4>
            <p>Coupon redemption is purely subjected to standard and specified terms and conditions mentioned by the respective retailer. Coupons are issued on behalf of the respective retailer. Hence, any damages, injuries, losses incurred by the end user by using the coupon is not the responsibility of PayflipWallet.in.</p>
            ...
            <p>All transactions on the PayflipWallet website, monetary and otherwise, are non-refundable, non-exchangeable and non-reversible, save and except in the event of proven gross negligence on the part of PayflipWallet or its representatives, in which event the user agrees that the user shall only be entitled to a refund of the amount actually paid by the user and actually received by PayflipWallet with respect to the recharge done by the user. </p>
            <p>This limitation applies whether the alleged liability is based on contract, tort, negligence, strict liability, or any other basis, even if PayflipWallet has been advised of the possibility of such damage. Because some jurisdictions do not allow the exclusion or limitation of incidental or consequential damages, PayflipWallet liability in such jurisdictions shall be limited to the extent of the amount actually paid for by any user while availing any of the services on the PayflipWallet website.</p>
            <h4>Modification of These Terms and Conditions of Use</h4>
            ...
            <h4>PayflipWallet is headquartered at:</h4>
            <p>PayflipWallet Systems Pvt. Ltd.
                <br> Lk2-Lohakhera, Sangrur
                <br> Punjab-148106 </p>
        </div>
        </div>
        </div>
