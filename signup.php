...
?>
    ...
    <head>
        ...
        <meta name="description" content="Create new Account - PayflipWallet ,online recharge fast service in india, prepaid recharges, postpaid recharges, dth recharges, googleplay recharge and more..">
        ...
        <script type="text/javascript" src="/resource/ajax/signup.js"></script>
...
<div class="headerlogo">PayflipWallet</div>
        ...
        <div class="recharge_card" style="margin-bottom:-28px">
            <div class="card-header">Create New Account</div>
            <br>
            <div id="error"></div>
            <form method="POST" action="" class="form-signup" id="signup-form" autocomplete="off">
                ...
                <input name="password" type="password" id="password" placeholder="Create Password">
                <button type="submit" name="signup" id="signup_button" class="btn red">SignUp</button>
                <div style="padding-top:10px;text-align:center">Already had an Account? <a href="https://payflipwallet.com/login" style="color:#fa8072" title="Login Account">Click Here To Login</a></div>
                <br>
        </div>
