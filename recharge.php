...
?>
    ...
    <head>
        ...
        <meta name="description" content="Mobile prepaid recharge - PayflipWallet ,online recharge fast service in india, prepaid recharges, postpaid recharges, dth recharges, googleplay recharge and more..">
        ...
        <script type="text/javascript" src="/resource/ajax/menuselect.js"></script>
    </head>
...
<div class="headerlogo">PayflipWallet</div>
           ...
           <ul>
                <li class="active">
                    <a href="javascript:void(0);">
                        <div><img src="/resource/images/mobile.png" height="35" width="35" alt="Mobile" title="Mobile Recharge"></div><span class="pd5">Mobile</span></a>
                </li>
                <li>
        ...
        <div style="display:block" id="prepaid">
            <div class="recharge_card">
                <div class="card-header">Prepaid Recharge</div>
                <br>
                <div id="error"></div>
                <form method="POST" action="" class="prepaid-login" id="prepaid-form" autocomplete="off">
                    ...
                    <input type="text" name="mobile" id="mobile" maxLength="10" onkeyup="showUser(this.value)" value="" placeholder="Mobile Number">
                    ...
                    <button type="submit" name="prepaid" id="prepaid_button" class="btn red">Proceed</button>
                </form>
                <br>
            </div>
        </div>
        <div style="display:none" id="postpaid">
            <div class="recharge_card">
                <div class="card-header">Postpaid Recharge</div>
                <br>
                <div id="error"></div>
                <form method="POST" action="" class="postpaid-login" id="postpaid-form" autocomplete="off">
                    <img style="margin:0 0 -40px" src="resource/images/ic_phone.png" height="20" width="20">
                    ...
                    <button type="submit" name="postpaid" id="postpaid-button" class="btn red">Proceed</button>
                </form>
                <br>
            </div>
        </div>
        ...
        <div class="contact-card">
            <div class="policy">
                ...
                <span><a href="https://payflipwallet.com/aboutus">About Us</a></span>
                <span><a href="https://payflipwallet.com/contactus">Contact Us</a></span>
                <span><a href="https://payflipwallet.com/refundpolicy">Refund Policy</a></span>
                <span><a href="https://payflipwallet.com/termsandconditions">Terms & conditions</a></span></div>
            <div class="downloadapp">DOWNLOAD APP</div>
            <div class="downloadapp1">
                <span><a  href="https://play.google.com/store/apps/details?id=com.payflipwallet.app"><img src="/resource/logos/download/google-play.png" alt="Download App"></a></span>
                <span><a  href="javascript:void(0);"><img src="/resource/logos/download/app-store-icon.png" alt="Download App"></a></span>
                <span><a  href="javascript:void(0);"><img src="/resource/logos/download/windows-store-btn.png" alt="Download App"></a></span>
            </div>
        </div>
        </div>
        <div class="top-footer" style="margin-top:-12px">
