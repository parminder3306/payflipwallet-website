<?php
	require_once('auth/session/walletlimit.php');
...
?>
    ...
    <head>
        ...
        <meta name="description" content="Profile - PayflipWallet ,online recharge fast service in india, prepaid recharges, postpaid recharges, dth recharges, googleplay recharge and more..">
        ...
        <script type="text/javascript" src="/resource/ajax/profile.js"></script>
...
<div class="headerlogo">PayflipWallet</div>
        ...
        <div class="plans-card" style="height:235px">
            <div style="border-bottom:1px solid #f2f2f2;padding:10px 28px;">Profile</div>
            <div style="float:right;margin-top:-30px;margin-right:25px;">KYC :
                <?php echo $kycstatus;?>
            </div>
            <br>
            <div style="margin-left:20px;color:#333">Your Wallet Limit :
                <?php echo $rslimit;?>
            </div>
            <div id="myProgress">
                <div id="myBar"></div>
            </div>
            <div style="float:right;margin-top:-18px;margin-right:9px;">
                <?php echo $prsent;?>
            </div>
            <div style="border-bottom:1px solid #f2f2f2;width:100%;margin-top:15px;"></div>
           <div class="avatar"><img src="/resource/images/ic_avatar.png"/></div>
        ...
        <div class="recharge_card" style="margin-bottom:-25px">
            ...
            <br>
            <div id="error"></div>
            <form method="POST" action="" id="profile-form" autocomplete="off">
                <img style="margin:0 0 -40px" src="resource/images/name.png" height="20" width="20">
                <input type="text" name="name" id="name" placeholder="Enter Name">
                <button type="submit" name="update" id="profile-button" class="btn red">Update</button>
                <center>
                    <div class="forget"><a href="https://payflipwallet.com/changepassword" title="Change Password">Change Password</a></div>
                </center>
            </form>
            <br>
        </div>
