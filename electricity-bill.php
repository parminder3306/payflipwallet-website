<?php
    ...
    <head>
        ...
        <meta name="description" content="Electricity bill - PayflipWallet ,online recharge fast service in india, prepaid recharges, postpaid recharges, dth recharges, googleplay recharge and more..">
...
<div class="headerlogo">PayflipWallet</div>
            ...
            <ul>
                ...
                <li class="active">
                    <a href="javascript:void(0)">
                        <div><img src="/resource/images/electricity.png" height="35" width="35" alt="Electricity" title="Electricity"></div><span class="pd5">Electricity</span></a>
                </li>
                <li>
        ...
        <div class="recharge_card" style="margin-bottom:30px">
            ...
            <br>
            <div id="error"></div>
            <form method="POST" action="" id="electricity-form" autocomplete="off">
                <img style="margin:0 0 -40px" src="resource/images/icon_electricity.png" height="20" width="20">
                <SELECT name="operator" id="operator">
                    <option value="">Select Operator</option>
                    <OPTION value="PANJAB STATE POWER">PANJAB STATE POWER CORPORATION</OPTION>
                </SELECT>
                <img style="margin:0 0 -40px" src="resource/images/customer.png" height="20" width="20">
                <input type="text" id="acnumber" name="acnumber" value="" placeholder="Account Number">
                ...
                <button type="submit" name="electricity" id="electricity-button" class="btn red">Proceed</button>
            </form>
            <br>
        </div>
        <div class="operator-card">
            <div style="font-size:11px;font-weight:600;color:#333;margin-bottom:15px;">Electricity Bill</div>
            <ul>
                <li>
                    <a href="javascript:void(0);">
                        <div><img src="/resource/logos/operators/42x42/electricity.png" height="50" width="50" alt="PSPCL" title="PSPCL"></div>PSPCL</a>
                </li>
            </ul>
        </div>
        <div class="card77">
            <h4>Pay Electricity Bill Online at PayflipWallet!</h4>
            <p>Gone are the days when one had to travel distance to pay electricity bill. In this busy scenario, nobody has time to pay electricity bill at the store that may result into delay in payment leading to extra charges i.e. late fees. PayflipWallet online bill payment service is here to make your life easier. Get rid of the electricity bill payment stress without standing in long queues, avail electricity bill online payment service of PayflipWallet. Paying electricity bill online is the most helpful option, you can pay your bill anywhere, anytime without crossing the deadline.</p>
            <p>Wherever you are, pay electricity bill online following easy steps. Just login to PayflipWallet.com, fill the requisite form &amp; amount and there you go!</p>
            <b>Spread Light, Make Electricity Bill Payment on Time | PayflipWallet.com</b>
            <p>Make Electricity Bill Payment Online and forget late fees. PayflipWallet electricity bills online payment is safe &amp; secure option for those busy people. You can get speedy bill payment done in few simple steps. Now bills would not be mounting up at your head, visit us &amp; pay electricity bill in few seconds. Avail fast, effortless and protected electricity bill payment service anytime from your mobile or desktop, no matter where you are, travelling, in the office or at home.</p>
            <p>At PayflipWallet, you can smoothly pay Electricity Bill through instant payment means as per your choice like Net banking, Debit/Credit Card or PayflipWallet Wallet. We ensure to make your experience a simplest one!</p>
            <p>So, pay your electricity bill more effectively at our platform!</p>
        </div>
        </div>
        </div>
