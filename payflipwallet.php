...
?>
    ...
    <head>
        ...
        <meta name="description" content="PayflipWallet Service ,online recharge fast service in india, prepaid recharges, postpaid recharges, dth recharges, googleplay recharge and more..">
...
<div class="headerlogo">PayflipWallet</div>
        ...
        <div class="addmoney-card" style="margin-bottom:145px">
            ...
            <form method="post" action="" id="addmoney-form" autocomplete="off">
                ...
                <div style="padding-top:10px;text-align:center">Upgrade Wallet : <a href="https://payflipwallet.com/walletkyc" style="color:#fa8072" title="Upgrade Wallet">Click Here</a></div>
            </form>
        </div>
        </div>
        <div style="background: #fff;border-radius:10px;padding:0;margin:135px 5% 0;width:90%;height:590px;">
            <div style="border-bottom:1px solid #ebebeb;padding:14px 30px 12px;font-size:15px;">Payflip Wallet Transactions</div>
            <div style="padding:6px 6px 11px;border-radius:3px;color:#000000;background:#f7f7f7">
                ...
                <div style="width: 70%;margin-top: -17px;font-size: 12px;font-weight:600;float:right">Status</div>
                ...
                <div style="width:11.7%;margin-top:-17px;font-size: 12px;font-weight:600;float:right">Type</div>
            </div>
...
$total=20+$viewmore;
$result=mysqli_query($sp,"SELECT * FROM transactions WHERE Userid='$userid' ORDER BY id DESC LIMIT 0,$total");
...
?>
                    ...
                    <div style="margin-bottom:2px;">
                        <div style="margin-left:20px;border-radius:5px" class="<?php echo $opname{$operator};?>"></div>
