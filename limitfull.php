<?php include 'auth/session/db.php'; ?>
    <!DOCTYPE html>
    <html lang='en-US'>
    ...
    <head>
        ...
        <meta name="description" content="UpgradeWallet - PayflipWallet ,online recharge fast service in india, prepaid recharges, postpaid recharges, dth recharges, googleplay recharge and more..">
...
<div class="headerlogo">PayflipWallet</div>
        ...
        <div class="card77">
            <center>
                <div style="margin-top:-4px;margin-left:-50px;"><img src="/resource/logos/wallet/walletlimit.png" title="Wallet Limit" alt="Wallet Limit" /></div>
                <div style="margin-left:-42px;margin-top:10px;margin-bottom:0;">Your Walllet Tansactions Limit : Rs.
                    <?php echo (isset($_GET['monthly']))?$sp->real_escape_string(trim($_GET['monthly'])):'';?>
                </div>
                <p style="font-weight:500;color:#ff7f50;margin-left:-40px;">Transactions Limit : FULL</p>
                <a href="https://payflipwallet.com/logout">
                    <button class="primary-btn" title="Logout">LOGOUT</button>
                </a>
                <a href="https://payflipwallet.com/walletkyc">
                    <p style="margin-right:30px;color:#ff6347;margin-bottom:-5px;margin-top:8px;font-size:12px">UpgradeWallet</p>
                </a>
            </center>
        </div>
        </div>
