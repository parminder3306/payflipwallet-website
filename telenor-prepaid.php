...
?>
    ...
    <head>
        ...
        <title>Telenor Prepaid Recharge</title>
...
<div class="headerlogo">PayflipWallet</div>
        ...
        <div class="recharge_card">
            <div class="card-header"><img style="margin-right:8px;" src="/resource/logos/operators/42x42/uninor.png" height="40" width="40" alt="Telenor" title="Telenor"></div>
            <br>
            <div id="error"></div>
