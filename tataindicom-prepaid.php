...
?>
    ...
    <head>
        ...
        <title>TataIndicom Prepaid Recharge</title>
...
<div class="headerlogo">PayflipWallet</div>
        ...
        <div class="recharge_card">
            <div class="card-header"><img style="margin-right:8px;" src="/resource/logos/operators/42x42/indicom.png" height="40" width="40" alt="TataIndicom" title="TataIndicom"></div>
            <br>
            <div id="error"></div>
